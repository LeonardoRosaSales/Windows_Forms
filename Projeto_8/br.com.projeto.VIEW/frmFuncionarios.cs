...
namespace Projeto_8.br.com.projeto.VIEW
{
    public partial class frmFuncionarios : Form
    {
        ...
        private void dg_consulta_funcionario_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txt_email.Text = dg_consulta_funcionario.CurrentRow.Cells[2].Value.ToString();
            txt_senha.Text = dg_consulta_funcionario.CurrentRow.Cells[3].Value.ToString();
            cb_cargo.Text = dg_consulta_funcionario.CurrentRow.Cells[4].Value.ToString();
            cb_nivel.Text = dg_consulta_funcionario.CurrentRow.Cells[5].Value.ToString();
            txt_rg.Text = dg_consulta_funcionario.CurrentRow.Cells[6].Value.ToString();
            txt_cpf.Text = dg_consulta_funcionario.CurrentRow.Cells[7].Value.ToString();
            ...
            txt_endereco.Text = dg_consulta_funcionario.CurrentRow.Cells[10].Value.ToString();
            txt_n.Text = dg_consulta_funcionario.CurrentRow.Cells[11].Value.ToString();
            txt_bairro.Text = dg_consulta_funcionario.CurrentRow.Cells[12].Value.ToString();
            txt_compl.Text = dg_consulta_funcionario.CurrentRow.Cells[13].Value.ToString();
            txt_cidade.Text = dg_consulta_funcionario.CurrentRow.Cells[14].Value.ToString();
            cb_uf.Text = dg_consulta_funcionario.CurrentRow.Cells[15].Value.ToString();
            txt_cep.Text = dg_consulta_funcionario.CurrentRow.Cells[16].Value.ToString();
