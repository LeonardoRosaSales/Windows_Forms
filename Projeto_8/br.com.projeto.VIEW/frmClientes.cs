...
namespace Projeto_8.br.com.projeto.VIEW
{
    public partial class frmClientes : Form
    {
        ...
        private void dg_consulta_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txt_rg.Text = dg_consulta.CurrentRow.Cells[3].Value.ToString();
            txt_cpf.Text = dg_consulta.CurrentRow.Cells[4].Value.ToString();
            ...
            txt_endereco.Text = dg_consulta.CurrentRow.Cells[7].Value.ToString();
            txt_n.Text = dg_consulta.CurrentRow.Cells[8].Value.ToString();
            txt_bairro.Text = dg_consulta.CurrentRow.Cells[9].Value.ToString();
            txt_compl.Text = dg_consulta.CurrentRow.Cells[10].Value.ToString();
            txt_cidade.Text = dg_consulta.CurrentRow.Cells[11].Value.ToString();
            cb_uf.Text = dg_consulta.CurrentRow.Cells[12].Value.ToString();
            txt_cep.Text = dg_consulta.CurrentRow.Cells[13].Value.ToString();
